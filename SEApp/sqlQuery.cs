...
namespace SEApp
{
    ...
    internal class sqlQuery
    {
         ...
         */
        // Select all the vendor and product data from their respective tables
        ...
        // Query to grab the vendor data that have been reviewed in the last 6 months
        ...
        // Query to Select the average ratings for all the products with reviews
        ...
        // Query to Select all the vendor data
        public const string allVendors = "SELECT * FROM VendorInfo";

        // Query to Select all the Product data
        public const string allProducts = "SELECT * FROM ProductInfo";

        // Queries to these Select the company, software names and cloud service type based on what cloud service they offer
        ...
        // Query to Select all of the Vendors Contact Information
        ...
        // Query to Select the Active Vendors Contact Information (They have been reviewed in the last 6 months)
        ...
        // Query to Select vendors that were established between 0 and 5 years, 6 and 10 years and over 10 years ago.
        ...
        // Queries to Select the specific Vendor and Product no matter what filter is applied in the VendorProducts Form
        ...
        // Queries to update the Vendor, Product and Contact Information in the Database
        ...
        // Deletes the selected Vendor from the Database.
        ...
        // Retrieves the PDF File Name for the user to view.
        public const string getPDFPath = "SELECT DocumentName FROM Document WHERE VendorID=@vendor AND ProductID=@product";
        

        
        // Selects all the usernames, passwords and emails from the UserInfo Database table
        public const string userInfo = "SELECT * FROM UserInformation";

        // Queries to Add all the required Vendor Information into the respective tables: VendorInfo, Contact and ProductInfo
